...
public final class ContentMainBinding implements ViewBinding {
  ...
  private ContentMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textUsername) {
  ...
  public static ContentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ContentMainBinding((ConstraintLayout) rootView, textUsername);
    }

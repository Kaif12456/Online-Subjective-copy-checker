...
public class AdminFragmentDirections {
  ...
  @NonNull
  public static ActionAdminhomeToAdminViewFragment actionAdminhomeToAdminViewFragment(
      @NonNull Pdf pdf) {
    return new ActionAdminhomeToAdminViewFragment(pdf);
  }

  public static class ActionAdminhomeToAdminViewFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionAdminhomeToAdminViewFragment(@NonNull Pdf pdf) {
      if (pdf == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAdminhomeToAdminViewFragment setPdf(@NonNull Pdf pdf) {
      if (pdf == null) {
        throw new IllegalArgumentException("Argument \"pdf\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("pdf", pdf);
    ...
    public int getActionId() {
      return R.id.action_adminhome_to_adminViewFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionAdminhomeToAdminViewFragment that = (ActionAdminhomeToAdminViewFragment) object;
    ...
    public String toString() {
      return "ActionAdminhomeToAdminViewFragment(actionId=" + getActionId() + "){"
          + "pdf=" + getPdf()
          + "}";
    }
  }
